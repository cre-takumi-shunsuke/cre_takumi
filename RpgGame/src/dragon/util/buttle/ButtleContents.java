...
public class ButtleContents {
     ...
     * @param offenceDragon:攻撃側のモンスター
     * @param defenceDragon:防御側のモンスター
     */
    ...
    public static void Attack(Action offenceAction,ButtleMonster offenceMonster, ButtleMonster defenceMonster){
        ...
        System.out.println(defenceMonster.getDragonName()+"は"+damage+"のダメージで残り体力が"+defenceMonster.getButtleHp()+"になった!");
    ...
    public static void outputActionList(ButtleMonster myMonster){
            System.out.println("\nコマンド\t\t技名\t\t\t\t残りポイント");
            System.out.println("\t1:\t\t"+myMonster.getActions().get(1).getActionName()+"\t\t"+myMonster.getActions().get(1).getButtleActionPoint() );
            System.out.println("\t2:\t\t"+myMonster.getActions().get(2).getActionName()+"\t\t"+myMonster.getActions().get(2).getButtleActionPoint() );
            System.out.println("\t3:\t\t"+myMonster.getActions().get(3).getActionName()+"\t\t"+myMonster.getActions().get(3).getButtleActionPoint() );
