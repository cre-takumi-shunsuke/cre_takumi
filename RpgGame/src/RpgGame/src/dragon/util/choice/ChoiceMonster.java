...
public class ChoiceMonster {
	...
	public static void searchDrageon() {
		...
		DefalutMonster monster2 = new DefalutMonster(2, "ブルースライム", 25);
		DefalutMonster monster3 = new DefalutMonster(3, "レッドオーク", 15);
	...
	private static ButtleMonster makeButtleMonster(int monsterId) {
		...
		case 1:
			...
			//モンスターのコンストラクタへの引数はID・モンスターの名前・HP
			...
			break;
		case 2:
			ButtleMonster monster2 = new ButtleMonster(2, "ブルースライム", 25);
			...
			break;
		case 3:
			ButtleMonster monster3 = new ButtleMonster(3, "レッドオーク", 15);
